public class IntTreeTester {
	public static void main(String[] args) {
		...
		// Example trees
		// Use PrintSideways to get a sense of the tree structures (and consult the
		// instruction)
